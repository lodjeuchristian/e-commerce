...
create or replace package pa_commande is
type sqlcur is ref cursor; 

	procedure put(num_carte char, num_utilisateur number, date_cmde date, etat_cmde varchar2, frais_cmde number, delais_livraison number, num_rue_livraison varchar2, cp_livraison varchar2, ville_livraison varchar2);
	...
	function getDerniereCommande return number;
...
Create or replace package body pa_commande is 

	-- ajouter une commande
	procedure put(num_carte char, num_utilisateur number, date_cmde date, etat_cmde varchar2, frais_cmde number, delais_livraison number, num_rue_livraison varchar2, cp_livraison varchar2, ville_livraison varchar2)
	is 
	begin
		insert into commande(num_carte, num_utilisateur, date_cmde, etat_cmde, frais_cmde, delais_livraison, num_rue_livraison, cp_livraison, ville_livraison) 
			values(num_carte, num_utilisateur, date_cmde, etat_cmde, frais_cmde, delais_livraison, num_rue_livraison, cp_livraison, ville_livraison);
		commit;
	end;
	...
	is
		lastcmd number(10);
	begin
		select max(num_cmde) into lastcmd from commande;
		return lastcmd;
	end getDerniereCommande;
