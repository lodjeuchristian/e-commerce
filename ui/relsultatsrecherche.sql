CREATE OR REPLACE PROCEDURE resultatsrecherche(champ varchar2)
IS
...
HTP.print('		
	...
	<hr/> 
			...
			');		
						...
						clivres:= pa_livre.getByChampRecherche(champ);
						LOOP
						...
						HTP.print('
							<div class="row">
								<div class="item active span3">   
									<a href="/g07_epg_dad/detailslivre?ref_livre=' || trim(ligne_livre.ref_livre) || '&' || 'lib_cmt=empty">  <img src="/public/img/livres/' || ligne_livre.couverture || '" alt="' || ligne_livre.titre_livre || '" style="width:190px"></a>		 
								</div>
								<div align="left" class="span4" style="margin-left:-55px;width:340px;">
						...
						HTP.print('<br/><br/> 
									<i class="icon-chevron-right"></i> <a href="/g07_epg_dad/detailslivre?ref_livre=' || trim(ligne_livre.ref_livre) || '&' || 'lib_cmt=empty#commentaires">Avis des utilisateurs</a>
...
<div id="myModal" class="modal hide fade" tabindex="-1" >
  <form method="POST" name="ajouterAuPanierForm" action="/g07_epg_dad/ajouteraupanier">   
    ...
    <div class="modal-footer">
	  ...
	  <button type="submit" name="redirecturl" value="resultatsrecherche?champ=' || champ || '" class="btn btn-info"> <i class="icon-shopping-cart icon-white"></i> Ajouter</button>
