CREATE OR REPLACE PROCEDURE touslesbonsplans
IS
...
HTP.print('		
	...
	<div class="container conteneurwtborder" id="fadeOutIn"> 
		<br/>
		<div>
			<div class="pull-left"><h4>Tous les bons plans</h4></div> 
		</div>
		<br/>
		<hr/>  
			...
			');		
						...
						HTP.print('<br/><br/> 
								...
								<div class="well pull-right">
									Prix public<br/><s><h5>' || ligne_livre.prix_livre || ' €</h5></s><h3><font color="darkorange">' || nouveau_prix || ' € </font></h3>
									<br/>En stock<br/>Expédié sous 24h
									<br/> 
									<br><button class="btn btn-info btn-large addToCardHome" href="#myModal" role="button" data-toggle="modal" id="'||ligne_livre.ref_livre||'"><h5><i class="icon-shopping-cart icon-white"></i> Ajouter au panier </h5></button>								</div>
							</div> 
							<hr/>
						');	 
 						end loop;
...
<div id="myModal" class="modal hide fade" tabindex="-1" >
  <form method="POST" name="ajouterAuPanierForm" action="/g07_epg_dad/ajouteraupanier">   
    ...
    <div class="modal-footer">
	  ...
	  <button type="submit" name="redirecturl" value="touslesbonsplans" class="btn btn-info"> <i class="icon-shopping-cart icon-white"></i> Ajouter</button>
