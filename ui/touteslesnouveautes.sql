CREATE OR REPLACE PROCEDURE touteslesnouveautes
IS
...
HTP.print('		
	...
	<div class="container conteneurwtborder" id="fadeOutIn"> 
		<br/>
		<div>
			<div class="pull-left"><h4>Toutes les nouveautés</h4></div> 
		</div>
		<br/>
		<hr/>  
			...
			');		
						...
						clivres:= pa_livre.getAllByLimit('date_parution', 'DESC',10);
						LOOP
...
<div id="myModal" class="modal hide fade" tabindex="-1" >
  <form method="POST" name="ajouterAuPanierForm" action="/g07_epg_dad/ajouteraupanier">   
    ...
    <div class="modal-footer">
	  ...
	  <button type="submit" name="redirecturl" value="touteslesnouveautes" class="btn btn-info"> <i class="icon-shopping-cart icon-white"></i> Ajouter</button>
